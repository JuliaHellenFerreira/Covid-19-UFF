...
# 03 - Flexibilizacao de funcionamento dos comercios:

medida3 <- "- Flexibilização de funcionamento dos comércios"
...
## 04 - Fechamento de comércio:

medida4 <- "- Fechamento de comércio"
